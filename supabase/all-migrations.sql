-- Pylon Fantasy — the whole schema, in order.
--
...
--   0042_dues.sql
--   0043_draft_position_caps.sql
--   0044_no_position_caps.sql
--   0045_game_time_lock.sql
...
--   0060_out_counts_for_the_reserve.sql
--   0061_waiver_day.sql
...
do $__migration__$
begin
  if exists (select 1 from schema_migrations where name = '0040_pylon_fantasy.sql') then
    raise notice 'skipping %, already applied', '0040_pylon_fantasy.sql';
  else
...
do $__migration__$
begin
  if exists (select 1 from schema_migrations where name = '0043_draft_position_caps.sql') then
    raise notice 'skipping %, already applied', '0043_draft_position_caps.sql';
  else
    ...
    insert into schema_migrations (name) values ('0043_draft_position_caps.sql');
    raise notice 'applied %', '0043_draft_position_caps.sql';
  end if;
end
$__migration__$;
...
do $__migration__$
begin
  if exists (select 1 from schema_migrations where name = '0044_no_position_caps.sql') then
    raise notice 'skipping %, already applied', '0044_no_position_caps.sql';
  else
    ...
    insert into schema_migrations (name) values ('0044_no_position_caps.sql');
    raise notice 'applied %', '0044_no_position_caps.sql';
  end if;
end
$__migration__$;
...
do $__migration__$
begin
  if exists (select 1 from schema_migrations where name = '0045_game_time_lock.sql') then
    raise notice 'skipping %, already applied', '0045_game_time_lock.sql';
  else
    ...
    insert into schema_migrations (name) values ('0045_game_time_lock.sql');
    raise notice 'applied %', '0045_game_time_lock.sql';
  end if;
end
$__migration__$;
...
do $__migration__$
begin
  if exists (select 1 from schema_migrations where name = '0046_injured_reserve.sql') then
    raise notice 'skipping %, already applied', '0046_injured_reserve.sql';
  else
    ...
    insert into schema_migrations (name) values ('0046_injured_reserve.sql');
    raise notice 'applied %', '0046_injured_reserve.sql';
  end if;
end
$__migration__$;
...
do $__migration__$
begin
  if exists (select 1 from schema_migrations where name = '0047_trade_votes_and_presence.sql') then
    raise notice 'skipping %, already applied', '0047_trade_votes_and_presence.sql';
  else
...
do $__migration__$
begin
  if exists (select 1 from schema_migrations where name = '0048_counter_keeps_its_author.sql') then
    raise notice 'skipping %, already applied', '0048_counter_keeps_its_author.sql';
  else
...
do $__migration__$
begin
  if exists (select 1 from schema_migrations where name = '0057_a_league_that_says_nothing_still_fields_a_team.sql') then
    raise notice 'skipping %, already applied', '0057_a_league_that_says_nothing_still_fields_a_team.sql';
  else
...
do $__migration__$
begin
  if exists (select 1 from schema_migrations where name = '0060_out_counts_for_the_reserve.sql') then
    raise notice 'skipping %, already applied', '0060_out_counts_for_the_reserve.sql';
  else
    ...
    insert into schema_migrations (name) values ('0060_out_counts_for_the_reserve.sql');
    raise notice 'applied %', '0060_out_counts_for_the_reserve.sql';
  end if;
end
$__migration__$;
...
do $__migration__$
begin
  if exists (select 1 from schema_migrations where name = '0061_waiver_day.sql') then
    raise notice 'skipping %, already applied', '0061_waiver_day.sql';
  else
    ...
    insert into schema_migrations (name) values ('0061_waiver_day.sql');
    raise notice 'applied %', '0061_waiver_day.sql';
  end if;
end
$__migration__$;
...
--   supabase/seed.sql, then  select * from seed_league('Pylon Fantasy', 12);
